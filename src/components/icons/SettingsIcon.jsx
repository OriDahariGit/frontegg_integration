const SettingsIcon = ({isHovered}) => {

  return (
    <svg fill={isHovered ? 'white' : 'var(--color-frontegg-dark)'} 
          className={`h-full aspect-square ${isHovered ? 'fill-white' : 'fill-frontegg-dark/80'}`} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
